...
iridescentBasicSynth::iridescentBasicSynth(float (&midiNotes)[128], AudioMixer4 *l, AudioMixer4 *r, Bounce *btn0, Bounce *btn1, Bounce *btn2, int rPin, int gPin, int bPin, int lPin, int lPin2, bool *instrumentBool) {
